...
!(function (a, b) {
                ...
                if (null != (a = arguments[h]))
                    for (b in a)
                        (c = g[b]),
                            (d = a[b]),
                            g !== d &&
                                (j && d && (o.isPlainObject(d) || (e = o.isArray(d))) ? (e ? ((e = !1), (f = c && o.isArray(c) ? c : [])) : (f = c && o.isPlainObject(c) ? c : {}), (g[b] = o.extend(j, f, d))) : void 0 !== d && (g[b] = d));
            return g;
        }),
        o.extend({
    ...
    (o.event = {
            ...
            if (
                ...
                return (
                    ...
                    e ||
                        ...
                        !o.acceptData(d) ||
                        (k && o.isFunction(d[q]) && !o.isWindow(d) && ((h = d[k]), h && (d[k] = null), (o.event.triggered = q), d[q](), (o.event.triggered = void 0), h && (d[k] = h))),
                    b.result
                );
            }
        },
        ...
        (o.Event = function (a, b) {
            return this instanceof o.Event
                ? (a && a.type ? ((this.originalEvent = a), (this.type = a.type), (this.isDefaultPrevented = a.defaultPrevented || (void 0 === a.defaultPrevented && a.getPreventDefault && a.getPreventDefault()) ? Z : $)) : (this.type = a),
                  b && o.extend(this, b),
    ...
    function tb(a) {
        ...
        return (
            c ||
                ((c = sb(a, b)),
                ("none" !== c && c) || ((qb = (qb || o("<iframe frameborder='0' width='0' height='0'/>")).appendTo(b.documentElement)), (b = qb[0].contentDocument), b.write(), b.close(), (c = sb(a, b)), qb.detach()),
                (rb[a] = c)),
            c
        );
    }
    ...
    function Hb(a, b, c, d, e) {
        for (var f = c === (d ? "border" : "content") ? 4 : "width" === b ? 1 : 0, g = 0; 4 > f; f += 2)
            "margin" === c && (g += o.css(a, c + R[f], !0, e)),
                d
                    ? ("content" === c && (g -= o.css(a, "padding" + R[f], !0, e)), "margin" !== c && (g -= o.css(a, "border" + R[f] + "Width", !0, e)))
    ...
    (o.Tween = Kb),
        (Kb.prototype = {
            ...
            run: function (a) {
                ...
                return (
                    (this.pos = b = this.options.duration ? o.easing[this.easing](a, this.options.duration * a, 0, 1, this.options.duration) : a),
    ...
    function Vb(a, b, c) {
        ...
        c.queue ||
            ...
            1 === a.nodeType &&
                ...
                ((c.overflow = [m.overflow, m.overflowX, m.overflowY]), (j = o.css(a, "display")), "none" === j && (j = tb(a.nodeName)), "inline" === j && "none" === o.css(a, "float") && (m.display = "inline-block")),
            c.overflow &&
                ((m.overflow = "hidden"),
                k.always(function () {
            ...
            attr: function (a, b, c) {
                ...
                if (a && 3 !== f && 8 !== f && 2 !== f)
                    return typeof a.getAttribute === U
                        ? o.prop(a, b, c)
                        : ((1 === f && o.isXMLDoc(a)) || ((b = b.toLowerCase()), (d = o.attrHooks[b] || (o.expr.match.bool.test(b) ? Zb : Yb))),
                          void 0 === c
        ...
        ajax: function (a, b) {
            ...
            function x(a, b, f, h) {
                ...
                2 !== t &&
                    ...
                    (u = vc(k, u, v, j)),
                    j
                        ? (k.ifModified && ((w = v.getResponseHeader("Last-Modified")), w && (o.lastModified[d] = w), (w = v.getResponseHeader("etag")), w && (o.etag[d] = w)),
        ...
        o.fn.extend({
            offset: function (a) {
                ...
                if (f)
                    return (
                        (b = f.documentElement),
                        o.contains(b, d) ? (typeof d.getBoundingClientRect !== U && (e = d.getBoundingClientRect()), (c = Kc(f)), { top: e.top + c.pageYOffset - b.clientTop, left: e.left + c.pageXOffset - b.clientLeft }) : e
                    );
            },
            position: function () {
                if (this[0]) {
                    ...
                    return (
                        "fixed" === o.css(c, "position")
                            ...
                            : ((a = this.offsetParent()), (b = this.offset()), o.nodeName(a[0], "html") || (d = a.offset()), (d.top += o.css(a[0], "borderTopWidth", !0)), (d.left += o.css(a[0], "borderLeftWidth", !0))),
